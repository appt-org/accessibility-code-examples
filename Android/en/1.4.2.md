...
button.<a href="https://developer.android.com/reference/android/view/View#setOnClickListener(android.view.View.OnClickListener)">setOnClickListener</a> {
    if (player.<a href="https://developer.android.com/reference/android/media/MediaPlayer#isPlaying()">isPlaying</a>()) {
        player.<a href="https://developer.android.com/reference/android/media/MediaPlayer#pause()">pause</a>() // Or: player.<a href="https://developer.android.com/reference/android/media/MediaPlayer#stop()">stop</a>()
    } else {
        player.<a href="https://developer.android.com/reference/android/media/MediaPlayer#start()">start</a>()
    }
}    
    </code>
</pre>
