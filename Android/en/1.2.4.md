...
val trackSelector = <a href="https://exoplayer.dev/doc/reference/index.html?com/google/android/exoplayer2/trackselection/DefaultTrackSelector.html">DefaultTrackSelector</a>(baseContext)
trackSelector.setParameters(
    trackSelector.buildUponParameters().setPreferredTextLanguage("nl")
)
val exoPlayer = <a href="https://exoplayer.dev/doc/reference/com/google/android/exoplayer2/SimpleExoPlayer.html">SimpleExoPlayer</a>.Builder(baseContext)
                    .setTrackSelector(trackSelector)
                    .build()
val dataSourceFactory: <a href="https://exoplayer.dev/doc/reference/com/google/android/exoplayer2/upstream/DataSource.html">DataSource</a>.Factory = DefaultHttpDataSourceFactory(
...
val mediaSource = <a href="https://exoplayer.dev/doc/reference/com/google/android/exoplayer2/source/hls/HlsMediaSource.html">HlsMediaSource</a>.Factory(dataSourceFactory).createMediaSource(mediaUri)
