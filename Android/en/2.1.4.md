...
override fun <a href="https://developer.android.com/reference/android/app/Activity#onKeyUp(int,%20android.view.KeyEvent)">onKeyUp</a>(keyCode: Int, event: <a href="https://developer.android.com/reference/android/view/KeyEvent">KeyEvent</a>): Boolean {
    return when (keyCode) {
        KeyEvent.KEYCODE_F -> {
            if (event.<a href="https://developer.android.com/reference/android/view/KeyEvent#isCtrlPressed()">isCtrlPressed</a>) {
                findContent()
                true
            }
        }
